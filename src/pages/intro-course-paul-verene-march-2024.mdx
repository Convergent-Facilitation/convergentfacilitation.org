...
:point_right: **[Practice Group Time Slots](/intro-course-paul-verene-march-2024-practice-group-sessions#when-are-facilitated-practice-group-sessions-happening)** (join any without registration, Zoom is the same as for the main session)
...
**We closed registrations on Feb 27th.** 

Due to a high level of interest we have decided to close registrations a week before the start of the course. This will give us time to process all applications and finalise preparation for the course. Please sign up to our [newsletter](/contact#stay-informed-with-our-cf-in-the-world-newsletter) to receive announcements of future introductory courses. 
:::
...
<center>
  <br/>
<span>
  <a href="#where-and-when-is-it-happening"> 
    <button className="button" style={{ background: 'lightgrey' }} type="submit">
	~~Register for Course~~
    </button>
  </a>
