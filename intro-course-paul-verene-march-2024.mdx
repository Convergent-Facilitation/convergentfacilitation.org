...
<LocalTime year={2024} month={03} day={05} startHour={15} startMinute={0} endHour={18} endMinute={0}/>.

# Course: Finding a Way Forward — An Introduction to Convergent Facilitation

**Dates and times: Tuesdays in March 2024: 5th, 12th, 19th, 26th**  


**Where: Online on Zoom**

This course is an in depth introduction to Convergent Facilitation - a powerful approach to facilitating collaborative decision making. The course will be run by Paul Kahawatte and Verene Nicolas, who are both leading practitioners of  Convergent Facilitation (C.F.).
